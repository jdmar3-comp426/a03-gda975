...
console.log('Testing getIncreasingArray(3,7) :');
console.log(getIncreasingArray(3,7));

// Testing maxAndMin
import {maxAndMin} from "./src/mild/mild_1.js";
console.log('Testing maxAndMin("4865324257412") :');
console.log(maxAndMin("4865324257412"));
...
// Testing countArray
console.log('Testing countArray([24, 5, 6, 17, 8, 6, 6, 7, 5, 23, 24, 8]) :');
console.log(countArray([24, 5, 6, 17, 8, 6, 6, 7, 5, 23, 24, 8]));